...
from tensorflow.keras.layers import Input, Conv2D, ZeroPadding2D, UpSampling2D, MaxPooling2D
...
if __name__ == '__main__':
    ...
    # python convert0.py data/yolov3.cfg data/yolov3.weights data/yolov3.h5
